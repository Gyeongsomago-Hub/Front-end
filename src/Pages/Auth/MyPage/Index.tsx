                      ...
                      <div className={style.contentGrid}>
                        {participations.map((participation) => (
                          <div key={participation.part_id} className={style.contentCard}>
                            ...
                            <p className={style.projectContent}>
                              {participation.introduce || "소개글이 없습니다."}
                            </p>
                    ...
                    <div className={style.infoLabel}>
                      <svg className={style.icon} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M8 7V3a4 4 0 118 0v4m-4 8a2 2 0 11-4 0 2 2 0 014 0zM8 7a2 2 0 11-4 0 2 2 0 014 0zM8 0z"
                        />
                      </svg>
                      마감일
                    </div>
